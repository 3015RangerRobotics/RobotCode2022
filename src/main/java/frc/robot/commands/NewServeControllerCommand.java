...
public class NewServeControllerCommand extends CommandBase {
    ...
    public NewServeControllerCommand(
    ...
    public void execute() {
        ...
        // Stupid inversion to make code work
        desiredState.holonomicRotation = new Rotation2d(-desiredState.holonomicRotation.getRadians());
        Translation2d t = desiredState.poseMeters.getTranslation();
        desiredState.poseMeters = new Pose2d(new Translation2d(t.getX(), -t.getY()), desiredState.poseMeters.getRotation());
